...
async function pairAndCreateMatches(tournamentId) {
    ...
    let availablePlayers = idlePlayersSnapshot.docs.map(doc => (Object.assign({ id: doc.id }, doc.data())));
    availablePlayers.sort((a, b) => {
        var _a, _b;
        const timeA = ((_a = a.lastGameFinishedAt) === null || _a === void 0 ? void 0 : _a.toMillis()) || a.joinedAt.toMillis();
        const timeB = ((_b = b.lastGameFinishedAt) === null || _b === void 0 ? void 0 : _b.toMillis()) || b.joinedAt.toMillis();
...
async function validateTournamentForStart(tournamentId, tournamentData) {
...
exports.onTournamentStateChange = functions.firestore
    ...
    if (before.state === 'published' && after.state === 'locked') {
        ...
        const validationResult = await validateTournamentForStart(tournamentId, Object.assign({}, after));
