...
const pieceStyles = {
  w: { fill: "#FFFFFF", stroke: "#18181B", strokeWidth: 1.5, strokeLinecap: "round" as const, strokeLinejoin: "round" as const },
  b: { fill: "#18181B", stroke: "#E4E4E7", strokeWidth: 1.5, strokeLinecap: "round" as const, strokeLinejoin: "round" as const },
};
...
const Knights = ({ color }: { color: PieceColor }) => (
  <svg viewBox="0 0 45 45" style={pieceStyles[color]}>
    ...
    <path d="M 25,18 C 25,18 26,17.5 26,19 C 26,20.5 25,20.5 25,20.5 C 25,20.5 23.5,20 23.5,19 C 23.5,18 25,18 25,18 z" fill={color === 'w' ? '#18181B' : '#E4E4E7'} />
  </svg>
);
...
const Bishops = ({ color }: { color: PieceColor }) => (
  <svg viewBox="0 0 45 45" style={pieceStyles[color]}>
    ...
    <path d="M15 14h15l-7.5 20L15 14z" />
    <path d="M22.5 14v20" fill="none" />
  </svg>
);
...
const Queens = ({ color }: { color: PieceColor }) => (
    <svg viewBox="0 0 45 45" style={pieceStyles[color]}>
        ...
        <circle cx="16.25" cy="12" r="2.5" />
        <circle cx="22.5" cy="12" r="2.5" />
        <circle cx="28.75" cy="12" r="2.5" />
